...
class SigninHost extends Component{
 ...
 onPasswordChange = (e) =>{
  ...
  onSubmit = () =>{
    fetch('http://localhost:3001/signin/place', {
      method: 'post',
  ...
  <div className="measure ">
    ...
    <div className="">
      <input  className="b ph3 pv2 input-reset white ba b--white bg-transparent grow pointer f6 dib" type="submit" value="Sign in" onClick = {this.onSubmit}/>
    </div>
    <div className="lh-copy mt3">
      <p className="f6 link dim white db pointer"
       onClick = {() => onRouteChange('newhost')}>
       New Host
       </p>     
    </div>
  </div>
