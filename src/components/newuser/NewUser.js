    ...
    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
      ...
      <div className="mt3">
       ...
       <div className="mt3">
        ...
        <input onChange = {this.onPnumberChange} className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="tel" name="phone-number"  id="phone-number"/>
      </div>
      <div className="mv3">
      ...
      <div className="mv3">
        ...
        <input className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" autoComplete='off' type="password" name="password"  id="password"/>
      </div>
    </fieldset>
    <div className="">
      <input onClick = {this.onRegister}  className="b ph3 pv2 input-reset ba b--white bg-transparent grow pointer f6 dib" type="submit" value="Create User"/>
    </div>
  </div>
